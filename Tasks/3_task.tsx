...
// !! Done We will briefly go over it on the lesson. But before you manipuate it. Put new buttons, list elements and icons and change its design.
// This is your first exercise. You can keep all the sidebar routing list items in an array of objects.
// !! Done Secondly, now we have content component with a sidebar element, but we need a page component beside the sidebar, so your second
...
// !! Done Thirdly, make this PageContainer component HOC (higher order component), so that you can put whatever inside bwtween its opening and
