...
// In this task we will make some useEffect examples to better understand it.
// The first thing is to fetch some data from json server by using fetch api using inside useEffect.
// Make sure that, the api only called once when the products page opened. We have gone through this in our previous lesson i.e.(how can we call the function inside)
// useEffect hook once in a lifetime of the component/page.
